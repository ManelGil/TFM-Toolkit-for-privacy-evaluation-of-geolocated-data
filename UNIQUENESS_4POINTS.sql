--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_4POINTS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_4POINTS" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of traces - 4 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_4POINTS
        (
          id,
