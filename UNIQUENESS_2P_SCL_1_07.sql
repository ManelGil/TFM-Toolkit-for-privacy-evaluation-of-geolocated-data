--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_2P_SCL_1_07
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_2P_SCL_1_07" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of T_TRANS_SCL_1_07 - 2 Points**********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_2P_SCL_1_07
        (
          id,
