--------------------------------------------------------
--  DDL for Procedure BEGIN_END_ROT_5DEG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."BEGIN_END_ROT_5DEG" 
(
  ...
  begin
    ...
    loop
      ...
      > TIME_DURATION then
        ...
        insert into T_BEGIN_END_ROT_5DEG (id, latitude, longitude, datetime)
