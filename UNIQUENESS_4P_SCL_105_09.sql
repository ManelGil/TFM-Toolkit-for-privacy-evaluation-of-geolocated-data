--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_4P_SCL_105_09
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_4P_SCL_105_09" 
(
  ...
  begin
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_4P_SCL_105_09
        (
          id,
