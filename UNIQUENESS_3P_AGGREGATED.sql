--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_3P_AGGREGATED
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_3P_AGGREGATED" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of TRACES_AGGREGATED - 3 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_3P_AGGREGATED
        (
          id,
