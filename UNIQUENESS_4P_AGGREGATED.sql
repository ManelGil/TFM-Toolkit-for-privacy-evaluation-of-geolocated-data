--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_4P_AGGREGATED
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_4P_AGGREGATED" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of TRACES_AGGREGATED - 4 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_4P_AGGREGATED
        (
          id,
