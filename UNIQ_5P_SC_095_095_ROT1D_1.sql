--------------------------------------------------------
--  DDL for Procedure UNIQ_5P_SC_095_095_ROT1D
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQ_5P_SC_095_095_ROT1D" 
(
  ...
  begin
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQ_5P_SC_095_095_ROT1D
        (
          id,
