--------------------------------------------------------
--  DDL for Procedure BEGIN_END_SCL_095_095_ROT_1DEG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."BEGIN_END_SCL_095_095_ROT_1DEG" 
(
  ...
  begin
    ...
    loop
      ...
      > TIME_DURATION then
        ...
        insert into T_BEGIN_END_SC_095_095_ROT1DEG (id, latitude, longitude, datetime)
...
END BEGIN_END_SCL_095_095_ROT_1DEG;
