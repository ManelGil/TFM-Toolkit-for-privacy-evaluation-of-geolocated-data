--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_3P_SCL_105_09
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_3P_SCL_105_09" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of T_TRANS_SCL_105_09 - 3 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_3P_SCL_105_09
        (
          id,
