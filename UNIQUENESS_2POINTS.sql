--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_2POINTS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_2POINTS" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of traces - 2 Points**********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_2POINTS
        (
          id,
