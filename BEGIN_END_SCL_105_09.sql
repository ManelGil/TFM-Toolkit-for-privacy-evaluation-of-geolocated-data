--------------------------------------------------------
--  DDL for Procedure BEGIN_END_SCL_105_09
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."BEGIN_END_SCL_105_09" 
(
  ...
  begin
    ...
    loop
      ...
      > TIME_DURATION then
        ...
        insert into T_BEGIN_END_SCL_105_09 (id, latitude, longitude, datetime)
