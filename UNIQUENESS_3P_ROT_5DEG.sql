--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_3P_ROT_5DEG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_3P_ROT_5DEG" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of T_TRANS_ROT_5DEG - 3 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_3P_ROT_5DEG
        (
          id,
