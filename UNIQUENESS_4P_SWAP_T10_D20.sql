--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_4P_SWAP_T10_D20
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_4P_SWAP_T10_D20" 
(
  ...
  begin
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_4P_SWAP_T10_D20
        (
          id,
...
END UNIQUENESS_4P_SWAP_T10_D20;
