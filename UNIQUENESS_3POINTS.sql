--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_3POINTS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_3POINTS" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of traces - 3 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_3POINTS
        (
          id,
