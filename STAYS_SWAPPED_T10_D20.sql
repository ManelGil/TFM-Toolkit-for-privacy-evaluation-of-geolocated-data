--------------------------------------------------------
--  DDL for Procedure STAYS_SWAPPED_T10_D20
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."STAYS_SWAPPED_T10_D20" 
(
      ...
      BEGIN
        ...
        loop
          ...
          if diameter > DISTANCE then
            ...
            /* Insertar stay en S (set of stays) -> t_stays_swapped_t600_d100 */
            /* S? S?(Medoid(R,i, j*),ti ,t j* ) ; */
            insert into T_STAYS_SWAPPED_T10_D20
            (
