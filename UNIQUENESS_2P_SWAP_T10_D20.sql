--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_2P_SWAP_T10_D20
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_2P_SWAP_T10_D20" 
(
  ...
  begin
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_2P_SWAP_T10_D20
        (
          id,
...
END UNIQUENESS_2P_SWAP_T10_D20;
