--------------------------------------------------------
--  DDL for Procedure BEGIN_END_SWAPPED_T10_D20
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."BEGIN_END_SWAPPED_T10_D20" 
(
  ...
  begin
    ...
    loop
      ...
      > TIME_DURATION then
        ...
        insert into T_BEGIN_END_SWAPPED_T10_D20 (id, latitude, longitude, datetime)
