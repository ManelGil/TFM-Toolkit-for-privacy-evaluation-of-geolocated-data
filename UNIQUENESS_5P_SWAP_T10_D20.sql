--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_5P_SWAP_T10_D20
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_5P_SWAP_T10_D20" 
(
...
BEGIN
  declare
    ...
    TYPE unique_trace IS RECORD (lat001 SWAPPED_TRACES_T10_D20.latitude001%TYPE, long001 SWAPPED_TRACES_T10_D20.longitude001%TYPE, dt SWAPPED_TRACES_T10_D20.datetime%TYPE); -- Record con latitud y longitud con precisión .001 y timestamp
  ...
  begin
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_5P_SWAP_T10_D20
        (
          id,
...
END UNIQUENESS_5P_SWAP_T10_D20;
