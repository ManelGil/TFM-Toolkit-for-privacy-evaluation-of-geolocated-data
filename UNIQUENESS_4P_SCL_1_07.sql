--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_4P_SCL_1_07
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_4P_SCL_1_07" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of T_TRANS_SCL_1_07 - 4 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_4P_SCL_1_07
        (
          id,
