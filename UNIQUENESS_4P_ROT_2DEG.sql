--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_4P_ROT_2DEG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_4P_ROT_2DEG" 
(
...
BEGIN
  declare
    ...
    TYPE unique_trace IS RECORD (lat001 T_TRANS_ROT_2DEG.latitude001%TYPE, long001 T_TRANS_ROT_2DEG.longitude001%TYPE, dt T_TRANS_ROT_2DEG.datetime%TYPE); -- Record con latitud y longitud con precisión .001 y timestamp
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of T_TRANS_ROT_2DEG - 4 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_4P_ROT_2DEG
        (
          id,
