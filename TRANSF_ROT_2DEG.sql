--------------------------------------------------------
--  DDL for Procedure TRANSF_ROT_2DEG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."TRANSF_ROT_2DEG" AS 
BEGIN
  declare
    M_R1_C1 number;
    M_R1_C2 number;
  ...
  begin
    DBMS_OUTPUT.PUT_LINE('********** Perturbación - Rotación de 2 grados respecto a 37.735085, -122.441601 **********');
    ...
    --2-Rotar ~2º
    COORD_ROTATION(THETA => 0.0349066, M_R1_C1 => M_R1_C1, M_R1_C2 => M_R1_C2, M_R1_C3 => M_R1_C3, M_R2_C1 => M_R2_C1, M_R2_C2 => M_R2_C2, M_R2_C3 => M_R2_C3, M_R3_C1 => M_R3_C1, M_R3_C2 => M_R3_C2, M_R3_C3 => M_R3_C3,
