--------------------------------------------------------
--  DDL for Procedure TRANSF_SCL_105_09
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."TRANSF_SCL_105_09" AS 
BEGIN
  declare
    M_R1_C1 number;
    M_R1_C2 number;
  ...
  begin
    DBMS_OUTPUT.PUT_LINE('********** Perturbación - Escala 1.05-0.9 respecto a 37.735085, -122.441601 **********');
    ...
    --2-Escalar con Sx=1.05 (se aleja del punto de origen) y Sy=0.9 (se acerca al punto de origen)
    COORD_SCALING(SX_LAT => 1.05, SY_LONG => 0.9, M_R1_C1 => M_R1_C1, M_R1_C2 => M_R1_C2, M_R1_C3 => M_R1_C3, M_R2_C1 => M_R2_C1, M_R2_C2 => M_R2_C2, M_R2_C3 => M_R2_C3, M_R3_C1 => M_R3_C1, M_R3_C2 => M_R3_C2, M_R3_C3 => M_R3_C3,
    ...
    insert into T_TRANS_SCL_105_09
    select
      id,
