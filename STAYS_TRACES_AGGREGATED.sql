--------------------------------------------------------
--  DDL for Procedure STAYS_TRACES_AGGREGATED
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."STAYS_TRACES_AGGREGATED" 
(
      ...
      BEGIN
        ...
        loop
          ...
          if diameter > DISTANCE then
            ...
            /* Insertar stay en S (set of stays) -> t_stays_traces_aggregated */
            /* S? S?(Medoid(R,i, j*),ti ,t j* ) ; */
            insert into t_stays_traces_aggregated
            (
