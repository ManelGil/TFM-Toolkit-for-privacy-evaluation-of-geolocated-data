--------------------------------------------------------
--  DDL for Procedure UNIQUENESS_5P_AGGREGATED
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."UNIQUENESS_5P_AGGREGATED" 
(
...
BEGIN
  ...
  begin
    ...
    DBMS_OUTPUT.PUT_LINE('********** Uniqueness of TRACES_AGGREGATED - 5 Points **********');
    ...
    begin
      ...
      loop
        ...
        insert into T_UNIQUENESS_5P_AGGREGATED
        (
          id,
