--------------------------------------------------------
--  DDL for Procedure STAYS_SCL_1_07
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."STAYS_SCL_1_07" 
(
      ...
      BEGIN
        ...
        loop
          ...
          if diameter > DISTANCE then
            ...
            /* Insertar stay en S (set of stays) -> t_stays_scl_1_07 */
            /* S? S?(Medoid(R,i, j*),ti ,t j* ) ; */
            insert into t_stays_scl_1_07
            (
