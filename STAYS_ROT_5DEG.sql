--------------------------------------------------------
--  DDL for Procedure STAYS_ROT_5DEG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYS"."STAYS_ROT_5DEG" 
(
      ...
      BEGIN
        ...
        loop
          ...
          if diameter > DISTANCE then
            ...
            /* Insertar stay en S (set of stays) -> t_stays_rot_5deg */
            /* S? S?(Medoid(R,i, j*),ti ,t j* ) ; */
            insert into t_stays_rot_5deg
            (
